...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$toKey = function(string) {
        ...
        } else return $author$project$Msg$PressedString(string);
    };
    var $author$project$Main$keyDecoder = A2($elm$json$Json$Decode$map, $author$project$Main$toKey, A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string));
    ...
    var $author$project$Update$focusSearchBox = A2($elm$core$Task$attempt, function(_v0) {
    ...
    var $author$project$Model$TodoCreate = F2(function(title, group) {
        return {
            group: group,
            title: title
        };
    });
    var $author$project$Update$todoCreate = A3($elm$json$Json$Decode$map2, $author$project$Model$TodoCreate, A2($elm$json$Json$Decode$field, 'title', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$field, 'group', $elm$json$Json$Decode$string));
    var $author$project$Update$update = F2(function(msg, model) {
        switch(msg.$){
            ...
            case 'PressedString':
                var string = msg.a;
                return string === 'Escape' ? _Utils_Tuple2(_Utils_update(model, {
                    show: false
                }), $elm$core$Platform$Cmd$none) : string === 'Enter' ? _Utils_Tuple2(_Utils_update(model, {
                    show: false,
                    text: ''
    ...
    var $author$project$View$renderInputModal = function(model) {
        return model.show ? A2($elm$html$Html$div, _List_fromArray([
    ...
    var $author$project$Main$main = $elm$browser$Browser$application({
        ...
        onUrlChange: $author$project$Msg$UrlChanged,
        onUrlRequest: $author$project$Msg$LinkClicked,
...
//# sourceMappingURL=index.5e8e39a4.js.map
